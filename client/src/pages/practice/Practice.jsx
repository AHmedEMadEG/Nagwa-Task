    ...
    <div className="container">
      <div className="wrapper">
        ...
        <div className="answers">
          <button ref={(ref) => (btnRefs.current[0] = ref)} onClick={()=> clicked("noun", 0)}>NOUN</button>
          <button ref={(ref) => (btnRefs.current[1] = ref)} onClick={()=> clicked("verb", 1)}>VERB</button>
          <button ref={(ref) => (btnRefs.current[2] = ref)} onClick={()=> clicked("adjective", 2)}>ADJECTIVE</button>
          <button ref={(ref) => (btnRefs.current[3] = ref)} onClick={()=> clicked("adverb", 3)}>ADVERB</button>
        </div>
      </div>
